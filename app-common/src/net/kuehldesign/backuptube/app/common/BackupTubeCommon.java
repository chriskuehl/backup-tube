...
public class BackupTubeCommon {
    ...
    public final String LOCATION_VIDEOS = "Videos";
    public final String LOCATION_VIDEOS_DELETED = "Deleted Videos";
    public final String LOCATION_VIDEO = ""; // video file, relative to video's folder, if using another dir REQUIRES a trailing slash
    public final String LOCATION_VIDEO_DATAFILE = "video.json"; // data for each video, relative to the video's folder
    public final String LOCATION_DATAFILE = "data.json"; // data in the root directory with info on all videos
